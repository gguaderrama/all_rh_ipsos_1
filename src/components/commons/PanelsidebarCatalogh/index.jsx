...
class PanelSideBar extends React.Component {
  ...
  render() {
    ...
    return (
      <div style={this.props.openSideBar === false ? { marginTop: '-48%',marginLeft: '75%', width: '25%', transition: 'width 400ms ease' } : { display: 'none', transition: 'display 400ms ease' }}>
        <Paper className={classes.root}  >
          ...
          <div> <h4>Proveedores seleccionados</h4></div>
          <Divider></Divider>
          <ListItem>
